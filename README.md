...
|:---:|:---:|
| Running Perfectly at [Home Assistant](.HA_VERSION) 0.94.1, iOS 12.3.1, MacOS Mojave 10.14.5 with Browsers: Chrome and Safari Latest (And probably in later versions)| This shows how up to date this repo is |
