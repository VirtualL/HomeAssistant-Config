...
I have installed HA on an PC with [PROXMOX](https://www.proxmox.com/en/downloads) (Open Sorce OS for Servers), I am currently running HA on  [Ubuntu Server 18.04](https://www.ubuntu.com/download/server) as Virtual Machine
*(all the Config will work as well with [Raspberry Pi 3](hhttps://www.raspberrypi.org/products/raspberry-pi-3-model-b/),on [Hassbian](https://www.home-assistant.io/docs/installation/hassbian/installation/) or any way you need)*
I regularly update my configuration files.

If you like anything here, Be sure to star my repo!
## Information
|  | [![LastCommit](https://img.shields.io/github/last-commit/.VirtualL/HomeAssistant-Config.svg?color=blue&style=plasticr)](https://github.com/VirtualL/HomeAssistant-Config/commits/master)|
|:---:|:---:|
| Runing Perfectly at [Home Assistant](.HA_VERSION) 0.73.1, iOS 11.4,MacOS High Seirra 10.13.5 with Browsers: Chrome and Safari Latest | This shows how up to date this repo is |
| [![GitHub stars](https://img.shields.io/github/stars/VirtualL/HomeAssistant-Config.svg)](https://github.com/VirtualL/HomeAssistant-Config/stargazers) | [![GitHub issues](https://img.shields.io/github/issues/VirtualL/HomeAssistant-Config.svg)](https://github.com/VirtualL/HomeAssistant-Config/issues) |
| Please :star: this repo if you find it useful, like these people have. | This is like my TODO list |
|[![License: Unlicense](https://img.shields.io/badge/license-Unlicense-blue.svg)](http://unlicense.org/)| [![contributions welcome](https://img.shields.io/badge/contributions-welcome-blue.svg?style=flat)](https://github.com/VirtualL/HomeAssistant-Config/pulls) |
...
I am using at my Asus [RT-AC66U](https://www.asus.com/us/Networking/RTAC66U/) Router custom frimware [Asuswrt-Merlin](https://asuswrt.lostrealm.ca/) and [DNS-O-Matic](https://dnsomatic.com) for easy access online via - DDNS, Which is routed through [Cloudflare](https://www.cloudflare.com/) for faster accsess with CDN ,Cache, Analytics, Avoid DDoS attacks and of course more security :)
...
**Siri**- Working  Without a flaws with the [Built-in HomeKit Component](https://www.home-assistant.io/components/homekit/) The only one (for now) that support Hebrew! Another alternative for install Homekit [Homebridge ](https://github.com/nfarina/homebridge)
**Alexa**- The fun part , first I been try to use the [Home Assistant Cloud](https://www.home-assistant.io/components/cloud/) But, its was doing a lot problems,
So I made An [Alexa Skill](https://developer.amazon.com/alexa-skills-kit) using [Haaska v3](https://github.com/mike-grant/haaska/)  , Amazon developer accuont , [AWS Lambda](https://aws.amazon.com/lambda/) and of course the [HA API](https://www.home-assistant.io/components/api/)  so now everyting working excellent, and without the [monthly payment](https://www.home-assistant.io/blog/2017/12/17/introducing-home-assistant-cloud/) upcoming :)
**Google Assistant**-  Working  With the [Home Assistant Cloud](https://www.home-assistant.io/components/cloud/) (For experimental purposes only - for now)
...
[Aqara Smart Light Switch Wireless](https://www.gearbest.com/alarm-systems/pp_610095.html?wid=1433363)
...
[Wall Switch-Sonoff Touch EU](https://www.itead.cc/smart-home/sonoff-touch.html) *
...
[Xiaomi Universal IR Remote Controller](https://www.gearbest.com/smart-home/pp_229556.html?wid=1527929)

(More recommended- [Broadlink RM Pro IR + RF Remote Controller](https://www.gearbest.com/smart-home-controls/pp_255607.html?wid=1433363))

<img src=extras/pictures/XiaomiIRRemoteController.jpg  width="150">
...
[Apple TV (4th generation)](https://www.apple.com/shop/buy-tv/apple-tv/apple-tv-32gb)-to Controll Siri and HomeKit outside the local network
...
* Improve Securty aspect All aroud.
