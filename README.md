...
|:---:|:---:|
| Running Perfectly at [Home Assistant](.HA_VERSION) 0.88.0, iOS 12.1.2, MacOS Mojave 10.14 with Browsers: Chrome and Safari Latest (And probably in later versions)| This shows how up to date this repo is |
